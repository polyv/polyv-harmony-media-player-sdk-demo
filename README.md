...
[![GitHub release](https://img.shields.io/badge/release-2.3.2-blue.svg)](https://github.com/polyv/polyv-harmony-media-player-sdk-demo/releases/tag/2.3.2)
...
#### 3.2 接口文档
[v2.3.2 接口文档](https://repo.polyv.net/harmony/documents/media_player_sdk/2.3.2/index.html)
#### 3.3 版本更新记录
